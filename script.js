const FACTS = [
  ...
  },
  {
    id: "hottest-planet",
    category: "Earth & space",
    myth: "Mercury is the hottest planet because it is closest to the Sun.",
    title: "Venus is hotter than Mercury.",
    answer: "Venus’s dense carbon-dioxide atmosphere traps heat in a runaway greenhouse effect, pushing its mean surface temperature to about 464°C (867°F).",
    detail: "Mercury receives more direct sunlight, but it has almost no atmosphere to retain that heat. Distance from the Sun matters; an atmosphere’s composition and density matter too.",
    year: 1962,
    dateLabel: "Atmosphere matters",
    type: "Planetary surprise",
    persistence: 0.9,
    source: "NASA Solar System Exploration",
    sourceUrl: "https://science.nasa.gov/solar-system/temperatures-across-our-solar-system/"
  },
  {
    id: "dark-side-moon",
    category: "Earth & space",
    myth: "One side of the Moon is always dark.",
    title: "The far side gets plenty of sunlight.",
    answer: "The Moon rotates once per orbit, so the same side faces Earth—but sunlight still sweeps across both hemispheres during each lunar day.",
    detail: "At new moon, the far side is in full sunlight while the near side faces its night. “Far side” describes what we cannot see from Earth; “dark side” incorrectly implies permanent darkness.",
    year: 1959,
    dateLabel: "Far side ≠ dark side",
    type: "Space-language myth",
    persistence: 0.98,
  ...
  },
  {
    id: "largest-desert",
    category: "Earth & space",
    myth: "The Sahara is the world’s largest desert.",
    title: "Antarctica is the largest desert.",
    answer: "Deserts are defined by low precipitation, not heat or sand. When polar deserts are included, Antarctica is larger; the Sahara is the largest hot desert.",
    detail: "Antarctica is covered in ice, yet its interior receives very little precipitation. The apparent contradiction disappears once “desert” is treated as a climate category rather than a picture of dunes.",
    year: 1957,
    dateLabel: "Polar desert",
    type: "Definition matters",
    persistence: 0.96,
    source: "USGS Landsat Image Mosaic of Antarctica",
    sourceUrl: "https://lima.usgs.gov/education.php"
  },
  {
    id: "oil-dinosaurs",
    category: "Physical science",
    myth: "Oil is made from dead dinosaurs.",
    title: "Petroleum mostly began with tiny marine life.",
    answer: "Crude oil formed from ancient plants and animals—especially organisms such as diatoms—buried in marine sediments and transformed by heat and pressure.",
    detail: "Much of that source material lived before dinosaurs existed. “Fossil fuel” means fuel formed from ancient organic matter; it does not mean a tank of gasoline was once a Tyrannosaurus.",
    year: 1900,
    dateLabel: "Older than dinosaurs",
    type: "Fossil-fuel myth",
    persistence: 0.98,
    source: "U.S. Energy Information Administration",
    sourceUrl: "https://www.eia.gov/energyexplained/oil-and-petroleum-products/in-depth.php"
  },
  {
    id: "bats-blind",
    category: "Life science",
    myth: "Bats are blind.",
    title: "Bats can see—often in very low light.",
    answer: "Bats have small eyes with sensitive vision. Echolocation is an additional way many bats navigate and hunt, not evidence that their eyes do nothing.",
    detail: "Vision varies among the more than 1,400 bat species, but “blind as a bat” is an expression, not a biological description.",
    year: 1940,
    dateLabel: "Never true",
    type: "Animal myth",
    persistence: 1,
    source: "U.S. Geological Survey",
    sourceUrl: "https://www.usgs.gov/faqs/are-bats-blind"
  },
  {
    id: "humans-from-monkeys",
    category: "Life science",
    myth: "Humans evolved from the monkeys alive today.",
    title: "Humans and other primates share ancestors.",
    answer: "Humans did not descend from any primate species living today. Our lineage and the chimpanzee lineage diverged from a shared ancestor roughly 8–6 million years ago.",
    detail: "Evolution branches like a bush; it does not climb a ladder toward humans. Humans are primates and great apes, while monkeys and apes share a more distant common ancestor.",
    year: 1871,
    dateLabel: "A branching family tree",
    type: "Evolution corrected",
    persistence: 1,
    source: "Smithsonian Human Origins Program",
    sourceUrl: "https://humanorigins.si.edu/education/frequently-asked-questions"
  },
  {
    id: "water-conducts",
    category: "Physical science",
    myth: "Water itself is a good conductor of electricity.",
    title: "Dissolved ions do most of the conducting.",
    answer: "Pure water is a poor electrical conductor. Everyday water conducts because it contains dissolved salts, minerals, and other substances that supply mobile ions.",
    detail: "This correction does not make water and electricity safe: natural, tap, and pool water all contain dissolved material and can conduct dangerous currents.",
    year: 1900,
    dateLabel: "The ions matter",
    type: "Chemistry nuance",
    persistence: 0.95,
    source: "USGS Water Science School",
    sourceUrl: "https://www.usgs.gov/water-science-school/science/conductivity-electrical-conductance-and-water"
  },
  {
    id: "antibiotics-viruses",
    category: "Body & health",
    myth: "Antibiotics can cure colds and flu.",
    title: "Antibiotics do not treat viruses.",
    answer: "Antibiotics target certain bacterial infections. Colds and influenza are viral, so antibiotics neither kill their cause nor make those illnesses resolve faster.",
    detail: "Unnecessary antibiotics can still cause side effects and encourage antimicrobial resistance. A viral illness can sometimes lead to a separate bacterial infection, which requires a clinician’s diagnosis.",
    year: 1945,
    dateLabel: "Bacteria ≠ viruses",
    type: "Medical misconception",
    persistence: 0.98,
    source: "Centers for Disease Control and Prevention",
    sourceUrl: "https://www.cdc.gov/antibiotic-use/about/"
  },
  {
    id: "emancipation-scope",
    category: "History",
    myth: "The Emancipation Proclamation freed every enslaved person.",
    title: "It was transformative—and deliberately limited.",
    answer: "The 1863 proclamation applied to areas in rebellion, leaving slavery untouched in loyal border states and exempted Confederate areas already under Union control.",
    detail: "Its reach expanded with Union military advances, and it authorized Black enlistment. Slavery throughout the United States was abolished by the Thirteenth Amendment in 1865.",
    year: 1863,
    dateLabel: "Read the 1863 fine print",
    type: "History widened",
    persistence: 0.98,
    source: "U.S. National Archives",
    sourceUrl: "https://www.archives.gov/exhibits/featured-documents/emancipation-proclamation"
  },
  {
    id: "rosa-parks",
    category: "History",
    myth: "Rosa Parks stayed seated simply because she was tired after work.",
    title: "She was a seasoned activist, not an accidental symbol.",
    answer: "By 1955, Parks had spent years organizing for racial justice and had served as secretary of the Montgomery NAACP branch for twelve years.",
    detail: "Her refusal was courageous, and reducing it to physical fatigue erases the political conviction behind it. Parks later explained that the tiredness she felt was being “tired of giving in.”",
    year: 1955,
    dateLabel: "The fuller 1955 story",
    type: "History restored",
    persistence: 1,
    source: "Library of Congress",
    sourceUrl: "https://www.loc.gov/exhibitions/rosa-parks-in-her-own-words/about-this-exhibition/"
  }
];
